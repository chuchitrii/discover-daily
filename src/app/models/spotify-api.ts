...
export interface QueueParameterObject {
  device_id?: string;
}
 ...
 */
type AudioAnalysisResponse = Object;
 ...
 */
type PlaylistCoverImageResponse = Array<ImageObject>;
 ...
 */
type UsersFollowPlaylistResponse = Array<boolean>;
 ...
 */
type ListOfUsersShowsResponse = PagingObject<ShowObjectSimplified>;
 ...
 */
type CheckUsersSavedShowsResponse = Array<boolean>;
 ...
 */
export interface ShowObjectFull extends ShowObjectSimplified {
